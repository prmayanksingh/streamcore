  ...
  return (
    <section className="px-[2em] md:px-[4em] pt-[8em] md:pt-[9em] lg:pt-[3em]">
      <div className="flex flex-col items-center gap-[2.5em] lg:gap-[2em]">
        <h3 className="w-fit text-[1.1em] md:text-[1.2em] lg:text-[1.4em] text-[#7D7D7D] text-center flex flex-col sm:flex-row sm:items-center">
          Home/ Blog/{" "}
          <span className="h-fit leading-[1.2em] border-b">{blog.title}</span>
        </h3>
        <h1 className="lg:w-[60rem] text-[4em] md:text-[6em] lg:text-[7em] text-center leading-[1.05em] font-semibold">
          {blog.title}
        </h1>
        <div className="flex flex-wrap gap-[.6em] justify-center pt-[1em]">
