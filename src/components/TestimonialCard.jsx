...
const TestimonialCard = ({ testimonial }) => {
  return (
    <div className="h-[35em] md:h-[36em] xl:h-[39em] w-full md:w-[29em] px-[1.8em] md:px-[2.5em] py-[2em] shrink-0 bg-[#1C1C1C] rounded-2xl md:rounded-4xl flex flex-col justify-between">
