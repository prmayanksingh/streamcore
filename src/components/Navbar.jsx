  ...
  return (
    <div className='sticky top-0 z-999 px-[2rem] md:px-[3rem] lg:px-[3.8rem] py-[1.5rem] md:py-[2rem] lg:py-[2.2rem] flex justify-between items-center text-[clamp(.5em,3vw,1em)]'>
        ...
        <div className='flex items-center gap-[1em] md:gap-[1.5em]'>
            <div className='backdrop-blur-md h-fit px-[.9em] md:px-[.8em] py-[.6em] md:py-[.4em] rounded-full'><i className="ri-lightbulb-line text-[1.2em] md:text-[1.5em]"></i></div>
            <h1 className='border-2 backdrop-blur-md rounded-full px-[.7em] md:px-[.9em] py-[.4em] md:py-[.4em] text-[1.2em] md:text-[1.2em] font-semibold'><span className='hidden md:inline'>Say Hello</span> <i className="ri-arrow-right-up-line"></i></h1>
